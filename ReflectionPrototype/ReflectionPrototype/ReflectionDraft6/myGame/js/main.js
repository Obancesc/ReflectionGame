...
MainMenu.prototype = 
{
	...
	create: function()
	{
		...
		button= game.add.sprite(30, 220, 'button');
		button.scale.setTo(3.5, 3.5);
		if(musicPlaying==0)
		{
		...
		titleText = game.add.text(70, 275, 'Press ENTER to play', {fontSize: '30px', fill: '#000'});
		titleText = game.add.text(70, 325, 'Press SPACE for rules', {fontSize: '30px', fill: '#000'});
